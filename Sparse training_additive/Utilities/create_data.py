...
def create_new(data_train, labels_train,hyperp, run_options, data_input_shape, label_dimensions,i_val):
    ...
    for j in range(1,i_val+1):
        ...
        if j>1:
            ...
            Network.load_weights("WEIGHTS"+'/'+"model_weights"+str(i_val-1)).expect_partial()
    
            y_pred=Network(data_train,hyperp)
