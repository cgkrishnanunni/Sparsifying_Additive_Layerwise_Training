...
###############################################################################
        ...
        kernel_initializer_classification = tf.keras.initializers.GlorotNormal(seed=123)

        bias_initializer_classification = tf.keras.initializers.GlorotNormal(seed=123)
