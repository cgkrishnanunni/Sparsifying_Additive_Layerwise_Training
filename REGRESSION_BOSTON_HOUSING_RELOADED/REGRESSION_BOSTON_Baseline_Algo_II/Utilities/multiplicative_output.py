...
def net_output_multiply(hyperp,hyperp_new, data, run_options, data_input_shape, label_dimensions,i_val,batch_pred_test):
    ...
    if i_val>1:
        for i_net in range(2,i_val+1):
            ...
            if i_net>2:
                ...
                y_pred_test_add= np.multiply(y_pred_test_add,Network(data))   
