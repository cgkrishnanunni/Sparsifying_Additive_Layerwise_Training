...
fname = {'$\mathcal{N}_1^2$','','','$\mathcal{N}_1^3$','','','$\mathcal{N}_1^4$','','','$\mathcal{N}_1^5$'};

x = [1:3:12]; y = [0.359;0.0475;0.00113;0.0000785]; 
...
plot([0:3:50],0.0162*ones(length([0:3:50]),1),'-*','Color','b');

legend('Relative $L^2$ error by Algorithm I','Relative $L^2$ error by Baseline network', 'Forward Thinking ($1.62 \times 10^{-2}$)')
