...
fname = {'$\mathcal{N}_1^2$','','','$\mathcal{N}_1^3$','','','$\mathcal{N}_1^4$','','','$\mathcal{N}_1^5$','','','$\mathcal{N}_1^6$','','','','','','','','','','','$\mathcal{N}_2$','','','$\mathcal{N}_3$','','','$\mathcal{N}_4$','','','$\mathcal{N}_5$','','','$\mathcal{N}_6$','','','$\mathcal{N}_7$','','','$\mathcal{N}_8$','','','$\mathcal{N}_9$'};

x = [1:3:21]; y = [0.1723;0.0254;0.004974;0.0006649;0.000266;0;0]; 
...
legend('Relative $L^2$ error by Algorithm I','Relative $L^2$ error by Algorithm 2','Relative $L^2$ error by Baseline network', 'Forward Thinking (Hettinger et al. [18]')
