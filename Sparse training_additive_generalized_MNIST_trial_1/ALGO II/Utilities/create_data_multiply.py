...
def create_new_multiply(data_train, labels_train,hyperp,hyperp_new, run_options, data_input_shape, label_dimensions,i_val):
    ...
    for j in range(1,i_val+1):
        ...
        if j==2:
            ...
            new_label=np.divide(new_label,y_pred)
