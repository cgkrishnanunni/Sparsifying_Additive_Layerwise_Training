...
###############################################################################
        ...
        kernel_initializer = RandomNormal(mean=0.0, stddev=0.05, seed=123)
        #bias_initializer = 'zeros'
        bias_initializer=RandomNormal(mean=0.0, stddev=0.05, seed=123)
        ...
        self.classification_layer = Dense(units = output_dimensions,
                                          activation = hyperp.classification_act, use_bias = True, kernel_initializer = kernel_initializer, bias_initializer = bias_initializer, name = 'classification_layer')
